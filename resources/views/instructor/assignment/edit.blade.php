    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card.card-default class="static">
                ...
                <x-form action="{{ route('dashboard.instructor.assignment.update', $result->id) }}"
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="score" class="mt-1 w-full" type="number" name="score"
                            :value="old('score', $result->score)" required autofocus autocomplete="score" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="feedback" class="mt-1 w-full" type="text" name="feedback"
                            :value="old('feedback', $result->feedback)" required autofocus autocomplete="feedback" />
